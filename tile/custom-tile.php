...
class DT_Contact_Portal_Tile
{
    ...
    public function dt_custom_fields( array $fields, string $post_type = "" ) {
        ...
        if ( $post_type === "contacts" || $post_type === "contact_portal"){
             ...
             */
            $fields["dt_contact_portal_keyselect"] = [
                'name' => "Key Select",
                'type' => 'key_select',
                "tile" => "dt_contact_portal",
                'default' => [
    ...
    public function dt_add_section( $section, $post_type ) {
         ...
         */
        if ( ( $post_type === "contacts" || $post_type === "contact_portal" ) && $section === "dt_contact_portal" ){
            /**
...
DT_Contact_Portal_Tile::instance();
