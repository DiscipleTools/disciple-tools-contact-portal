...
/**
 * Class DT_Contact_Portal_Base
 * Load the core post type hooks into the Disciple Tools system
 */
class DT_Contact_Portal_Base extends DT_Module_Base {
    ...
    public function dt_set_roles_and_permissions( $expected_roles ){
        ...
        if ( !isset( $expected_roles["multiplier"] ) ){
            $expected_roles["multiplier"] = [
                ...
                "label" => __( 'Multiplier', 'dt-contact-portal' ),
    ...
    public function dt_custom_fields_settings( $fields, $post_type ){
        if ( $post_type === $this->post_type ){
             ...
             */
            $fields['status'] = [
                'name'        => __( 'Status', 'dt-contact-portal' ),
                'description' => _x( 'Set the current status.', 'field description', 'dt-contact-portal' ),
                'type'        => 'key_select',
                'default'     => [
                    'inactive' => [
                        'label' => __( 'Inactive', 'dt-contact-portal' ),
                        'description' => _x( 'No longer active.', 'field description', 'dt-contact-portal' ),
                        'color' => "#F43636"
                    ],
                    'active'   => [
                        'label' => __( 'Active', 'dt-contact-portal' ),
                        'description' => _x( 'Is active.', 'field description', 'dt-contact-portal' ),
                        'color' => "#4CAF50"
                    ],
                ],
                'tile'     => 'status',
            ...
            $fields['assigned_to'] = [
                'name'        => __( 'Assigned To', 'dt-contact-portal' ),
                'description' => __( "Select the main person who is responsible for reporting on this record.", 'dt-contact-portal' ),
                'type'        => 'user_select',
                'default'     => '',
                'tile' => 'status',
             ...
             */
            $fields['start_date'] = [
                'name'        => __( 'Start Date', 'dt-contact-portal' ),
                'description' => '',
                'type'        => 'date',
                'default'     => time(),
                'tile' => 'details',
            ...
            $fields['end_date'] = [
                'name'        => __( 'End Date', 'dt-contact-portal' ),
                'description' => '',
                'type'        => 'date',
                'default'     => '',
                'tile' => 'details',
            ...
            $fields['location_grid'] = [
                'name'        => __( 'Locations', 'dt-contact-portal' ),
                'description' => _x( 'The general location where this contact is located.', 'Optional Documentation', 'dt-contact-portal' ),
                'type'        => 'location',
                'mapbox'    => false,
                "in_create_form" => true,
                "tile" => "details",
            ...
            $fields['location_grid_meta'] = [
                'name'        => __( 'Locations', 'dt-contact-portal' ), //system string does not need translation
                'description' => _x( 'The general location where this record is located.', 'Optional Documentation', 'dt-contact-portal' ),
                'type'        => 'location_meta',
                "tile"      => "details",
                'mapbox'    => false,
                'hidden' => true
            ...
            $fields["contact_address"] = [
                "name" => __( 'Address', 'dt-contact-portal' ),
             ...
             */
            $fields["parents"] = [
                "name" => __( 'Parents', 'dt-contact-portal' ),
                'description' => '',
                "type" => "connection",
            ...
            $fields["peers"] = [
                "name" => __( 'Peers', 'dt-contact-portal' ),
                'description' => '',
                "type" => "connection",
                "post_type" => $this->post_type,
                "p2p_direction" => "any",
            ...
            $fields["children"] = [
                "name" => __( 'Children', 'dt-contact-portal' ),
                'description' => '',
                "type" => "connection",
                "post_type" => $this->post_type,
                "p2p_direction" => "to",
             ...
             */
            $fields["peoplegroups"] = [
                "name" => __( 'People Groups', 'dt-contact-portal' ),
                'description' => _x( 'The people groups connected to this record.', 'Optional Documentation', 'dt-contact-portal' ),
                "type" => "connection",
                "post_type" => $this->post_type,
                "p2p_direction" => "to",
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = "" ){
        if ( $post_type === $this->post_type ){
            $tiles["connections"] = [ "label" => __( "Connections", 'dt-contact-portal' ) ];
            $tiles["other"] = [ "label" => __( "Other", 'dt-contact-portal' ) ];
        }
        return $tiles;
    }
    ...
    public function dt_details_additional_section( $section, $post_type ){
        ...
        if ( $post_type === $this->post_type && $section === "other" ) {
            ...
            <div class="section-subheader">
                <?php esc_html_e( "Custom Section Contact", 'dt-contact-portal' ) ?>
            </div>
            <div>
    ...
    public static function dt_user_list_filters( $filters, $post_type ){
        ...
        if ( $post_type === self::post_type() ){
            ...
            $filters["tabs"][] = [
                "key" => "assigned_to_me",
                "label" => _x( "Assigned to me", 'List Filters', 'dt-contact-portal' ),
                "count" => $total_my,
                "order" => 20
            ];
            ...
            $filters["filters"][] = [
                'ID' => 'my_all',
                'tab' => 'assigned_to_me',
                'name' => _x( "All", 'List Filters', 'dt-contact-portal' ),
                'query' => [
                    'assigned_to' => [ 'me' ],
                    'sort' => 'status'
                ],
            ...
            if ( current_user_can( 'view_any_' . self::post_type() ) ){
                ...
                $filters["tabs"][] = [
                    "key" => "all",
                    "label" => _x( "All", 'List Filters', 'dt-contact-portal' ),
                    "count" => $total_all,
                    "order" => 10
                ];
                // add assigned to me filters
